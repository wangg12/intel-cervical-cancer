...
def get_and_crop_image(image_path):
    ...
    # get image
    img = get_image_data(image_path) # shape: (H,W,C)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='../data/IntelMobileODT_Cervical_Cancer_Screening/', help='path to dataset root folder')
    parser.add_argument('--test_idx',  default='../data_utils/test.csv', help='path to test idx file, does not contain label')
    parser.add_argument('--train_idx', default='../data_utils/train_idx.csv',
                    help='path to train idx file, set to ./data_utils/val_idx.csv to do quick debug the train process')
    parser.add_argument('--val_idx',   default='../data_utils/val_idx.csv', help='path to val idx file')

    parser.add_argument('--workers',    type=int, default=4,   help='number of data loading workers')

    parser.add_argument('--save_dir', default='../data/IntelMobileODT_Cervical_Cancer_Screening/masked' )
